...
extern int tn_crypto_h7 (unsigned char *r, unsigned char key[16], unsigned char w[16]);
extern int tn_crypto_h8 (unsigned char *r, unsigned char k[16], unsigned char s[16], unsigned char keyId[4]);
