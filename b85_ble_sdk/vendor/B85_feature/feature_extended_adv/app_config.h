...
#define MULTI_ADV_SET								1   //multiple adv_set

/* for user to select adv_set test mode*/
#define	ADV_SET_MODE								SINGLE_ADV_SET
...
#define DEBUG_CODE_IN_RAM							1 //debug code run quicker

#if (PRINT_DEBUG_ENABLE)

	#define	PRINT_TYPE_SELECT						PRINT_USB_BULK_IN_OUT


	#if (PRINT_TYPE_SELECT == PRINT_USB_BULK_IN_OUT)
